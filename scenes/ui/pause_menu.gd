...
func _configure_focus() -> void:
	...
	save_button.focus_neighbor_bottom = load_button.get_path()
	load_button.focus_neighbor_top = save_button.get_path()
	load_button.focus_neighbor_bottom = abandon_button.get_path()
	abandon_button.focus_neighbor_top = load_button.get_path()
...
func _apply_localization() -> void:
	...
	load_button.text = _text("ui.pause.load")
